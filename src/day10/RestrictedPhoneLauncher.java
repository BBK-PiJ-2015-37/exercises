public class RestrictedPhoneLauncher {

	public static void main(String[] args) {
		RestrictedPhoneLauncher launcher = new RestrictedPhoneLauncher();
		launcher.launch();
	}

	public void launch() {
		Phone myMobile = new RestrictedSmartPhone("Sony Xperia Z3");
		RestrictedSmartPhone mobile1 = (RestrictedSmartPhone) myMobile;
